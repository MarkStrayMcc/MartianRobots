...
namespace Martian.Robots.Tests.Core.Commands
{
    ...
    public class TurnRightCommandTests
    {
        ...
        [Test]
        public void Execute_NorthTurnsEast()
        {
        ...
        [Test]
        public void Execute_EastTurnsSouth()
        {
        ...
        [Test]
        public void Execute_SouthTurnsWest()
        {
        ...
        [Test]
        public void Execute_WestTurnsNorth()
        {
        ...
        public void Execute_FullRotation_ReturnsToOriginalOrientation()
        {
            ...
            var result = position;
            for (int i = 0; i < 4; i++) // 4 right turns = 360°
            {
        ...
        [Test]
        public void Symbol_ReturnsR()
        {
            Assert.That(_command.Symbol, Is.EqualTo('R'));
        }
        #endregion
        ...
        #region Immutability Check
        [Test]
        public void Execute_ReturnsNewPositionInstance()
        {
            var position = new Position(0, 0, Orientation.N);
            var result = _command.Execute(position, _worldMock.Object);
